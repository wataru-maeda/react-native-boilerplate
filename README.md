...
### ☁️ Code formatting, fixing and testing on pre-commit [CI]
...
### 📱 Create automatic previews release on Pull-Request [CD]
...
1. Whenever you create a pull request (PR) or merge changes into the **main**, ***dev*** branch, it automatically generates a preview channel in your Expo account.
